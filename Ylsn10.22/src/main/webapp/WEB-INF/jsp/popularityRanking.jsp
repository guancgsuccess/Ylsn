...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/popularityRanking.js"></script>
...
<div class="search_box">
    <div class="search_bg clear">
        ...
        <ul class="search_tab" id="channel_bar">
            <li id="bar_default"><a href="${pageContext.request.contextPath}/search/load" target="_blank" class="left">全部会员</a></li>
    ...
    <div class="cont">
        <div class="search_info clear" style="padding-bottom:5px;border:0;">
            ...
            <ul class="jy_tab">
                <li class="cur"><a href="${pageContext.request.contextPath}/popularityRanking">人气排行首页</a></li>
                <li><a href="${pageContext.request.contextPath}/popularityRankingDay" >人气日榜</a></li>
                <li><a href="hot_more.php?t=1005">人气周榜</a></li>
                <li><a href="hot_more.php?t=1006">人气月榜</a></li>
                <li><a href="hot_more.php?t=1007">人气总榜</a></li>
            </ul>
        </div>
        <!-- active -->
        <h1 class="hy_title clear">
            ...
            <a href="${pageContext.request.contextPath}/popularityRankingDay">更多&gt;&gt;</a>
        </h1>
        <div class="clear">
            <div class="w_500 f_l">
        ...
        <div class="clear">
            <div class="w_500 f_l">
                <ul class="user_list clear" id="week_user_list" style="padding-right: 20px; z-index: 2;">
                </ul>
            </div>
        </div>
        <!-- sincere -->
        ...
        <div class="clear">
            <div class="w_500 f_l">
                <ul class="user_list clear" id="month_user_list" style="padding-right: 20px; z-index: 2;">
        ...
        <div class="clear">
            <div class="w_500 f_l">
                <ul class="user_list clear" id="total_user_list" style="padding-right: 20px; z-index: 2;">
